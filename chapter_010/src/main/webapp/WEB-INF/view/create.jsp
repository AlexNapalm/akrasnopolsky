    ...
    <form action="" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
        <div class="form-group row">
            <div class="col-xs-4">
                ...
                <select id="carbrand" class="form-control" name="brand_id" required>
        ...
        <div class="form-group row">
            <div class="col-xs-4">
                <label for="cartype">Кузов</label>
                <select id="cartype" class="form-control" name="carcase_id" required>
